 ...
 * Copyright (c) 2009-2011 by zanthia, Inc. All Rights Reserved.
...
//@interface zanthiaObject : NSObject
//@end

@interface zanthiaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[zanthiaObject class]])
		{
			for (NSString *key in [[(zanthiaObject*)o modules] allKeys])
			{
