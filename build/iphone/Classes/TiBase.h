...
// in simulator we redefine to format for zanthia Developer console
...
{\
	NSString * exceptionName = [@"org.zanthia." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.zanthia";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIzanthiaNativeItemNone = -1, 
	UIzanthiaNativeItemSpinner = -2,
	UIzanthiaNativeItemProgressBar = -3,
	
	UIzanthiaNativeItemSlider = -4,
	UIzanthiaNativeItemSwitch = -5,
	UIzanthiaNativeItemMultiButton = -6,
	UIzanthiaNativeItemSegmented = -7,
	
	UIzanthiaNativeItemTextView = -8,
	UIzanthiaNativeItemTextField = -9,
	UIzanthiaNativeItemSearchBar = -10,
	
	UIzanthiaNativeItemPicker = -11,
	UIzanthiaNativeItemDatePicker = -12,
	
	UIzanthiaNativeItemInfoLight = -13,
	UIzanthiaNativeItemInfoDark = -14,
	
	UIzanthiaNativeItemDisclosure = -15,
	
	UIzanthiaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all zanthia instances of
